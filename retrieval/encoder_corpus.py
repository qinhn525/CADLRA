...
class Encoder(object):
    #pretrained_model是经过训练集训练的BERT模型，特别注意max_seq_length=40
    ...
    def predict_by_file(self, infile, outfile):
        ...
        with open(infile, 'r') as f:
            for line in f:
                ...
                if count % 10000 == 0:
                    print ("Finish: ", count)
                    #line为corpus.tsv文件按行读取，“did \t doc 描述”  eg：”30000003	你好大人不能把手放在睡觉婴儿胸口，对孩子呼吸不好，要注意“
                ...
                if len(line) == 3:
                    text = line[1] + ' ' + line[2]
                #text两种类型，一种是context，一种是title+context
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", default="../output_model/medical_model/bert-base-chinese_cls/", type=str, help="sbert or prop")
    parser.add_argument("--max_sequence_length", default=256, type=int, help="sbert or prop")
    parser.add_argument("--input_file", default="../data/medical/corpus.tsv", type=str, help="input file with raw text")
    parser.add_argument("--output_file", default="../indices/medical/ct_corpus.pt", type=str, help="output file save embeddings")
