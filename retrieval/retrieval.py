...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", default="/home/longjing/zlz/Multi-CPR-main/retrieval/output_model/lawer_data_model/bert_cls_2/checkpoint-6000/", type=str)
    parser.add_argument("--pool_type", default="cls", type=str, help="pool type of the final text repsesentation")
    parser.add_argument("--max_sequence_length", type=int, default=512, help="use pb model or tf checkpoint")
    parser.add_argument("--index_file", default="indices/lawer_data/ct_corpus2.pt", type=str)
    parser.add_argument("--topk", type=int, default=5)
    parser.add_argument("--input_file", default="../data/lawer_data/dev_case2.txt", type=str)
    parser.add_argument("--output_file", default="./output/lawer_data/bert-base-chinese_cls.dev2.l2.tok5.out", type=str)
